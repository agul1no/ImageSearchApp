...
class UnsplashImageAdapter (private val listener: OnRecyclerViewItemClickListener, private val downloadListener: OnDownloadButtonClickListener) : PagingDataAdapter<UnsplashImage, UnsplashImageAdapter.ImageViewHolder>(IMAGE_COMPARATOR) {
